...
class unqoverGProcessor(SquadProcessor):
    train_file = "train-v1.1.json"
    dev_file = "unqover_gender.json"

class unqoverRProcessor(SquadProcessor):
    train_file = "train-v1.1.json"
    dev_file = "unqover_religion.json"

class unqoverNProcessor(SquadProcessor):
    train_file = "train-v1.1.json"
    dev_file = "unqover_nationality.json"

class unqoverEProcessor(SquadProcessor):
    train_file = "train-v1.1.json"
    dev_file = "unqover_ethnicity.json"
